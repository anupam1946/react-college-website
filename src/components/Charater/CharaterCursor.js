...
export const CharacterCursor = ({
    ...
    useEffect(() => {
        ...
        const randomPositiveOrNegativeOne = () =>
            Math.random() < 0.5 ? -1 : 1;
        ...
        class Particle {
            ...
            update(context) {
                ...
                const scale = characterScalingFunction(
                    this.age,
                    this.initialLifeSpan
                );
        ...
        const init = () => {
            ...
            characters.forEach((char) => {
                ...
                if (bgContext) {
                    ...
                    bgCanvas.height =
                        measurements.actualBoundingBoxAscent * 2.5;
                ...
                for (let i = 0; i < e.touches.length; i++) {
                    addParticle(
                        ...
                        canvImagesRef.current[
                            Math.floor(
                                Math.random() * canvImagesRef.current.length
                            )
                        ]
                    );
                }
